...
data_18_19<-read.csv("/Users/apple/Desktop/DIC lab 1/part2/task4/plot2.csv")
data<-rbind(filter(data_18_19,(data_18_19$YEAR==2018 & data_18_19$WEEK >=40)),filter(data_18_19,(data_18_19$YEAR==2019 & data_18_19$WEEK <=6)))
